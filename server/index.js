...
// portal API perm wall on Form_Types_Report et al. CORS is already open
// via app.use(cors()) at the top of this file.
...
app.get('/api/lookups/material-form-detail', async (req, res) => {
  try {
